...
namespace BladeAeternum.UI
{
    ...
    public class PostDuelSummaryUI : MonoBehaviour
    {
        ...
        #region State
        private CoreManagers.DuelFlowController duelFlowController;
        #endregion
        ...
        private void Awake()
        {
            ...
            duelFlowController = FindObjectOfType<CoreManagers.DuelFlowController>();
        }
        ...
        {
            HideSummary();
            if (duelFlowController != null)
                duelFlowController.enabled = true; // Resume duel loop
        }
        #endregion
